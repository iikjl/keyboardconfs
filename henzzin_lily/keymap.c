 ...
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *                   | LAlt | LGUI |nav| /enter  /       \space \  |lower | raise| DEL  |
 *                   |      |      |      |/       /         \      \ |      |      |      |
 *                   `----------------------------'           '------''--------------------'
 */
 ...
 [_QWERTY] = LAYOUT(
  ...
  KC_LCTRL,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC_CAPS,  KC_MINS,  KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,  KC_RSFT,
                             KC_LALT, KC_LGUI,MO(_NAVIGATION), KC_ENT, KC_SPC,  MO(_LOWER),   MO(_RAISE), KC_DEL
),
/* LOWER
 * ,-----------------------------------------.                    ,-----------------------------------------.
 ...
 * |      |      |      |      |      |      |-------|    |-------|      |   _  |   +  |   {  |   }  |   |  |
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *                   | LAlt | LGUI |nav| /enter  /       \space \  |lower | raise| RGUI |
 *                   |      |      |      |/       /         \      \ |      |      |      |
 *                   `----------------------------'           '------''--------------------'
 */
[_LOWER] = LAYOUT(
 ...
 * |      |      |      |      |      |      |                    |      |      |      |      |      |      |
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * |      | ins  | home | PG UP|PG DW |  END |                    |      |      |      |      |      |      |
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * |      |vol+  |vol-  | nxt  | prv  | pl/ps|-------.    ,-------|      |      |      |      |      |      |
 * |------+------+------+------+------+------|PRSCN  |    |       |------+------+------+------+------+------|
 * |      | mute |      |      |      |      |-------|    |-------|      |      |      |      |      |      |
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *                   | LAlt | LGUI |nav| /enter  /       \space \  |lower | raise| RGUI |
...
[_RAISE] = LAYOUT(
  ...
  _______, KC_INS, KC_HOME, KC_PGUP, KC_PGDN, KC_END,                   XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
  _______, KC_VOLU, KC_VOLD, KC_MPRV, KC_MNXT, KC_MPLY,                   XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
  _______, KC_MUTE, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_PSCR, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, _______,
                             _______, _______, _______,  _______, _______,  _______, _______, _______
),
/* nav
 * ,-----------------------------------------.                    ,-----------------------------------------.
